...
app.get("/", (req, res) =>
  res.redirect("/webcam_face_expression_recognition"),
);
...
app.get("/face_landmark_detection", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "faceLandmarkDetection.html"),
  ),
);
app.get("/face_expression_recognition", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "faceExpressionRecognition.html"),
  ),
);
app.get("/age_and_gender_recognition", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "ageAndGenderRecognition.html"),
  ),
);
...
app.get("/video_face_tracking", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "videoFaceTracking.html"),
  ),
);
app.get("/webcam_face_detection", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "webcamFaceDetection.html"),
  ),
);
...
app.get("/bbt_face_landmark_detection", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "bbtFaceLandmarkDetection.html"),
  ),
);
app.get("/bbt_face_similarity", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "bbtFaceSimilarity.html"),
  ),
);
...
app.get("/bbt_face_recognition", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "bbtFaceRecognition.html"),
  ),
);
app.get("/batch_face_landmarks", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "batchFaceLandmarks.html"),
  ),
);
app.get("/batch_face_recognition", (req, res) =>
  res.sendFile(
    path.join(viewsDir, "batchFaceRecognition.html"),
  ),
);
